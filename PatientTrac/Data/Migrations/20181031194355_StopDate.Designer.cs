...
namespace PatientTrac.Data.Migrations
{
    ...
    [Migration("20181031194355_StopDate")]
    partial class StopDate
    {
            ...
            modelBuilder.Entity("PatientTrac.Models.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "ef2beb35-b8d7-47de-bb65-4c90c140310c", AccessFailedCount = 0, ConcurrencyStamp = "b5734860-d2dc-4846-9abc-460a9860bc10", Email = "admin@admin.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "ADMIN@ADMIN.COM", NormalizedUserName = "ADMIN@ADMIN.COM", PasswordHash = "AQAAAAEAACcQAAAAEBeXVZYjWDxqFJdc3qFi5en9X9i7+kbxpGAWmoZdHcYyd5oKwlzQdBgFajOkdp32mQ==", PhoneNumberConfirmed = false, SecurityStamp = "b4fbcdba-4522-40b1-be98-37d669d18f3a", TwoFactorEnabled = false, UserName = "admin@admin.com", Facility = "Vanderbilt", FirstName = "Jill", LastName = "Scott" }
                    );
                });
