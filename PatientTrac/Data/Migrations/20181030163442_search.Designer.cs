...
namespace PatientTrac.Data.Migrations
{
    ...
    [Migration("20181030163442_search")]
            ...
            modelBuilder.Entity("PatientTrac.Models.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "069f4cdc-85f1-4a5b-8287-08aeb65d2687", AccessFailedCount = 0, ConcurrencyStamp = "8cb63aef-48a2-4edb-9a80-3c6a8c2e2ace", Email = "admin@admin.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "ADMIN@ADMIN.COM", NormalizedUserName = "ADMIN@ADMIN.COM", PasswordHash = "AQAAAAEAACcQAAAAEADTJNJHz3mtUIFar4jKSFll6/XYoNIRDCB4oT+yZl5EqURyJEFCsv6Zr1MEM45ylA==", PhoneNumberConfirmed = false, SecurityStamp = "482b96fb-8c58-48c3-bfd3-cd2e688cad89", TwoFactorEnabled = false, UserName = "admin@admin.com", Facility = "Vanderbilt", FirstName = "Jill", LastName = "Scott" }
                    );
                });
